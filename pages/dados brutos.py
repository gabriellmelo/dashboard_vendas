...
# This section of code is creating a sidebar in the Streamlit app interface with various expandable
# sections for filtering the data displayed in the main table. Each expandable section contains
# different filter options related to the dataset columns. Here's a breakdown of what each part is
# doing:
...
# This section of code is creating a query string based on the selected filter options in the sidebar
# of the Streamlit app. The query string is used to filter the dataset (`dados`) based on the
# user-selected criteria. Here's a breakdown of what each part of the query string is doing:
query = '''
